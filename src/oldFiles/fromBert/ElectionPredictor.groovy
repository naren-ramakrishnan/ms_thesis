...
writer = new FileAtomPrintStream("isMemberElection.txt")
inference.printAtoms(isMember, writer, false)

writer = new FileAtomPrintStream("groupLikesHashtagElection.txt")
inference.printAtoms(groupLikesHashtag, writer, false)
writer = new FileAtomPrintStream("groupHatesHashtagElection.txt")
inference.printAtoms(groupHatesHashtag, writer, false)
writer = new FileAtomPrintStream("groupLikesGroupElection.txt")
inference.printAtoms(groupLikesGroup, writer, false)
writer = new FileAtomPrintStream("groupHatesGroupElection.txt")
