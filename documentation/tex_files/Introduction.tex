...
Given that the language used on Twitter is completely different from the language in newspapers and magazines, this process gives a very low recall.\aravind{Recall is used as a place holder. How to word this better?}
...
\item
Showing how the vocabulary obtained from the Dynamic Query Expansion exercise improves the recall\aravind{again placeholder} and accuracy of the prediction algorithms.
\end{itemize}
